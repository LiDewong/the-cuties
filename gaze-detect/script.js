...
video.addEventListener("play", () => {
  ...
  setInterval(async () => {
    ...
    const resizedDetections = await faceapi
    ...
    if (resizedDetections[0]) {
      ...
      const dist2 = Math.sqrt(
        Math.pow(nosetip.x - rightcheek.x, 2) +
          Math.pow(nosetip.y - rightcheek.y, 2)
      );
      const lookLeft1 = dist1 / dist2;
      const lookRight1 = dist2 / dist1;
      const dist3 = Math.sqrt(
        Math.pow(lefteye.x - rightcheek.x, 2) +
          Math.pow(lefteye.y - rightcheek.y, 2)
      );
      const dist4 = Math.sqrt(
        Math.pow(righteye.x - rightcheek.x, 2) +
          Math.pow(righteye.y - rightcheek.y, 2)
      );
      ...
      function calc_EAR(eye) {
        const A = Math.sqrt(
          Math.pow(eye[1][0] - eye[5][0], 2) +
            Math.pow(eye[1][1] - eye[5][1], 2)
        );
        const B = Math.sqrt(
          Math.pow(eye[2][0] - eye[4][0], 2) +
            Math.pow(eye[2][1] - eye[4][1], 2)
        );
        const C = Math.sqrt(
          Math.pow(eye[0][0] - eye[3][0], 2) +
            Math.pow(eye[0][1] - eye[3][1], 2)
        );
